...
Por último, se comparan los pronósticos obtenidos contra los datos reales (en color rojo). Los resultados son mucho mejor con la regresión con **RF** (series azul, naranja, gris) que con la regresión lineal (verde).
